    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file_source', models.FileField(storage=celadon.s3utils._MediaS3BotoStorage(bucket=b'celadon', custom_domain=b'celadon.s3.amazonaws.com', location=b'media'), null=True, upload_to=carbon.compounds.core.models.title_file_name, blank=True)),
                ('file_minified', models.FileField(storage=celadon.s3utils._MediaS3BotoStorage(bucket=b'celadon', custom_domain=b'celadon.s3.amazonaws.com', location=b'media'), null=True, upload_to=carbon.compounds.core.models.title_file_name, blank=True)),

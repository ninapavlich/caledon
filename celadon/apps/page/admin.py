...
from .models import Page, PageContentBlock, PageSlide
...
class ProjectSlideInlineAdmin(TabularInlineOrderable):
...
class PageAdmin(BasePageAdmin, UnsavedChangesAdmin):
    ...
    # core_fields_list.append( ('sketch_bg_rgb', 'sketch_width', 'sketch_height'))

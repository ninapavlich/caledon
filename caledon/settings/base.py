...
from caledon import env
import caledon as project_module
...
GRAPPELLI_INDEX_DASHBOARD = 'caledon.apps.core.dashboard.AdminDashboard'
...
if IS_ON_SERVER:    
    ALLOWED_HOSTS = ['caledon.herokuapp.com', '.caledon.com', 
        '.caledon.com.', 'caledon.s3.amazonaws.com', 's3.amazonaws.com',]
...
AWS_STORAGE_BUCKET_NAME = env.get("AWS_STORAGE_BUCKET_NAME", 'caledon')
AWS_STORAGE_BUCKET_NAME_MEDIA = env.get("AWS_STORAGE_BUCKET_NAME_MEDIA", 'caledon')
...
AWS_STORAGE_BUCKET_NAME_MEDIA_SECURE = 'caledon-media-secure'
...
DEFAULT_FILE_STORAGE = 'caledon.s3utils.MediaS3BotoStorage'
MEDIA_MODEL = 'media.Media'
SECURE_MEDIA_MODEL = 'media.SecureMedia'
MEDIA_STORAGE = 'caledon.s3utils.MediaS3BotoStorage'
SECURE_MEDIA_STORAGE = 'caledon.s3utils.SecureMediaS3BotoStorage'
...
IMAGE_STORAGE = 'caledon.s3utils.MediaS3BotoStorage'
...
if IS_ON_SERVER:
    ...
    STATICFILES_STORAGE = 'caledon.s3utils.StaticS3BotoStorage'
...
if env.get("MEMCACHED_URL"):
    ...
    CACHES = {
        'default': {
            ...
            'KEY_PREFIX': env.get("CACHE_KEY_PREFIX", 'caledon')
        }
...
# Email Settings
#==============================================================================
HELP_EMAIL = "info@caledon.com"
HELP_PHONE = '303-564-7939'
DEFAULT_FROM_EMAIL = env.get("EMAIL_SENDER", "info@caledon.com")
...
from caledon.settings.content_settings import *

...
from caledon.apps.page.sitemap import *
...
urlpatterns +=  patterns('',
    ...
    url(r'^', include('caledon.apps.media.urls')),
    url(r'^', include('caledon.apps.form.urls')),
    url(r'^', include('caledon.apps.email.urls')),
    url(r'^', include('caledon.apps.page.urls')),

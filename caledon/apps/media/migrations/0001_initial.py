    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(help_text=b'To ensure a precise color replication in image variants, make sure an sRGB color profile has been assigned to each image.', storage=caledon.s3utils._MediaS3BotoStorage(bucket=b'caledon', custom_domain=b'caledon.s3.amazonaws.com', location=b'media'), null=True, upload_to=carbon.atoms.models.media.image_file_name, blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image_height', models.IntegerField(null=True, blank=True)),
                ('image', models.ImageField(help_text=b'To ensure a precise color replication in image variants, make sure an sRGB color profile has been assigned to each image.', storage=caledon.s3utils._MediaS3BotoStorage(bucket=b'caledon', custom_domain=b'caledon.s3.amazonaws.com', location=b'media'), null=True, upload_to=carbon.atoms.models.media.image_file_name, blank=True)),
                ('file', models.FileField(storage=caledon.s3utils._MediaS3BotoStorage(bucket=b'caledon', custom_domain=b'caledon.s3.amazonaws.com', location=b'media'), null=True, upload_to=carbon.atoms.models.media.media_file_name, blank=True)),

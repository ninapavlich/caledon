    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file_source', models.FileField(storage=caledon.s3utils._MediaS3BotoStorage(bucket=b'caledon', custom_domain=b'caledon.s3.amazonaws.com', location=b'media'), null=True, upload_to=carbon.compounds.core.models.title_file_name, blank=True)),
                ('file_minified', models.FileField(storage=caledon.s3utils._MediaS3BotoStorage(bucket=b'caledon', custom_domain=b'caledon.s3.amazonaws.com', location=b'media'), null=True, upload_to=carbon.compounds.core.models.title_file_name, blank=True)),
